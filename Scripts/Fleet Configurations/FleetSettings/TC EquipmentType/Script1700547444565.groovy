...
CustomKeywords.'fleet_configurations.EquipmentType.add_equipment_type'()

CustomKeywords.'fleet_configurations.EquipmentType.update_equipment_type'()

CustomKeywords.'fleet_configurations.EquipmentType.delete_equipment_type'()
