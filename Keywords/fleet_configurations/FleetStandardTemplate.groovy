...
public class FleetStandardTemplate {
	...
	def add_fleet_template() {
		...
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/button_add Add Fleet Data'))
		
		WebUI.delay(GlobalVariable.LOW_TIMESLEEP)
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputEquipment ID'), 'ID001')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputEquipment Name'), 'Adding name')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputMake'), 'testing')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputModel'), 'testing')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputSIN'), 'testing')
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/Equipment Type'))
				
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_equipment type 1'))
		
		WebUI.click(findTestObject('OR Fleet Configurations/OR FleetTemplates/Parent Equipment'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_equipment name'))
		
		WebUI.click(findTestObject('OR Fleet Configurations/OR FleetTemplates/Fleet Category'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_Category 12'))
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputShort Description'), 'testing desc')
		...
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_Week'))
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputUnit Rate Work'), '25')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputUnit Rate travel'), '25')
		
		WebUI.setText(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/inputUnit Cost'), '15')
				
		WebUI.click(findTestObject('OR Fleet Configurations/OR FleetTemplates/Division'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_101  Hazmat'))
		...
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_101  Richmond BC'))
		
		WebUI.click(findTestObject('OR Fleet Configurations/OR FleetTemplates/Department'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_101  Health and Safety'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/IsEnable'))
		
		WebUI.setText(findTestObject('OR Fleet Configurations/OR FleetTemplates/input date'), '23102023')
		...
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_Canada'))
		
		WebUI.click(findTestObject('OR Fleet Configurations/OR FleetTemplates/Province'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/li_Manitoba'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/button_Add'))
	...
	def delete_fleet_template() {
		...
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/buttonrow-delete'))
		
		WebUI.click(findTestObject('Object Repository/OR Fleet Configurations/OR FleetTemplates/button_Delete'))
