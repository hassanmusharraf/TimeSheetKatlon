...
public class WCB {
	...
	def add_WCB() {
		...
		WebUI.click(findTestObject('Object Repository/OR WorkForce Configuration/WCB/Page_QM Timesheet/mat-icon_keyboard_arrow_down'))
		
		WebUI.click(findTestObject('Object Repository/OR WorkForce Configuration/WCB/Page_QM Timesheet/div_engineering Workforce Configuration'))
		
		WebUI.click(findTestObject('Object Repository/OR WorkForce Configuration/WCB/Page_QM Timesheet/div_noise_control_off WCB'))
	...
	@Keyword
	def delete_WCB() {
		WebUI.click(findTestObject('Object Repository/OR WorkForce Configuration/WCB/Page_QM Timesheet/button_mat-focus-indicator flex justify-cen_187649'))
