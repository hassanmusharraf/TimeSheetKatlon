...
class AngularLocator {

	@Keyword
	public static TestObject replaceXPath(TestObject originalObject, String replacement) {
		// Get the existing XPath
		String originalXPath = originalObject.findPropertyValue('xpath')

		// Replace a part of the XPath with the new value
		String newXpath = originalXPath.replace("your_placeholder", replacement)

		// Create a new TestObject with the updated XPath
		TestObject newObject = new TestObject()
		newObject.addProperty('xpath', ConditionType.EQUALS, newXpath)
