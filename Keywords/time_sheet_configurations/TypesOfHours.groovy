...
public class TypesOfHours {

	@Keyword
	def add_type_of_hours() {
		WebUI.delay(GlobalVariable.MED_TIMESLEEP)

		WebUI.navigateToUrl(GlobalVariable.BASE_URL+'super-admin/type-of-hours/list')
	...
	def delete_type_of_hours() {
		...
		WebUI.click(findTestObject('Object Repository/OR TimeSheet Configuration/TypesOfHours/button_Delete'))

		WebUI.delay(GlobalVariable.LOW_TIMESLEEP)
	}
	@Keyword
	def goto_type_of_hours() {
		WebUI.delay(GlobalVariable.LOW_TIMESLEEP)
